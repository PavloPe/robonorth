...
export const robots: Robot[] = [
  ...
  // ── 23. 1X NEO Beta ──────────────────────────────────────────────────
  {
    ...
    description:
      'The Beta variant of 1X\'s NEO line features an upgraded EVE 2.0 vision system, improved grasping with 24-DOF hands, and a slimmer 28 kg frame. Designed for the early-adopter consumer market, it ships with a companion app for task scheduling, voice commands, and remote monitoring. Pre-orders include a 6-month software update guarantee.',
    specs: {
      height: 165,
      weight: 28,
      dof: 78,
  ...
  // ── 24. Apptronik Apollo 2 ───────────────────────────────────────────
  {
    ...
    description:
      'The second generation of Apptronik\'s industrial humanoid, Apollo 2 adds 12-DOF dexterous hands, an upgraded compute module with on-device LLM inference, and extends battery life to 6 hours via a quick-swap hot-plug system. Mercedes-Benz has committed to a 500-unit deployment across three German and two US plants, with Canadian pilot applications now open.',
    specs: {
      height: 175,
      weight: 70,
      dof: 44,
  ...
  // ── 26. Unitree H1-2 ─────────────────────────────────────────────────
  {
    ...
    manufacturer: 'Unitree Robotics',
    manufacturerSlug: 'unitree-robotics',
    price: '$120,000–$180,000 USD',
    priceMin: 120000,
    availability: 'shipping',
    category: 'research',
    useCase: ['advanced research', 'industrial R&D', 'reinforcement learning', 'outdoor operations'],
    description:
      'Unitree\'s upgraded full-size research platform. The H1-2 adds IP54 weatherproofing, an NVIDIA Jetson Thor compute module, and dual 6-DOF dexterous hands. Max joint torque increased to 420 N·m. Now supports cold-weather operation down to -20°C, making it one of the few humanoids rated for Canadian winters.',
    specs: {
      height: 180,
      weight: 52,
      dof: 31,
  ...
  // ── 27. Sanctuary AI Phoenix Gen 2 ───────────────────────────────────
  {
    ...
    availability: 'pilot',
    category: 'enterprise',
    useCase: ['general-purpose labor', 'retail', 'automotive', 'healthcare'],
    description:
      'The second generation of Canada\'s leading humanoid. Phoenix Gen 2 features the Carbon 2.0 cognitive architecture with 3× faster task learning — new skills can be acquired in under 8 hours. Hands now offer 24-DOF with haptic feedback and 2-millinewton tactile sensitivity. Built in Vancouver with Magna International as a manufacturing partner for automotive deployments across Ontario.',
    specs: {
      height: 172,
      weight: 65,
      dof: 48,
  ...
  // ── 28. Kepler Forerunner K2 ──────────────────────────────────────────
  {
    ...
    description:
      'Kepler\'s budget-conscious second-generation humanoid aimed squarely at SMEs. The K2 reduces cost through a modular design — buy the base platform and add arm/hand modules as needed. Ships with a no-code task builder that lets non-engineers program workflows via drag-and-drop. At $22K base, it\'s the cheapest enterprise-grade humanoid available.',
    specs: {
      height: 170,
      weight: 72,
      dof: 38,
  ...
  // ── 29. Agility Digit V2 ──────────────────────────────────────────────
  {
    ...
    availability: 'shipping',
    category: 'enterprise',
    useCase: ['warehouse logistics', 'order fulfillment', 'trailer unloading', 'palletizing'],
    description:
      'The second production version of Agility\'s warehouse humanoid, now shipping from the expanded RoboFab facility. V2 adds a head-mounted stereo camera for better bin-picking accuracy, wrist-mounted force sensors, and a 35% longer battery life. Amazon has ordered 1,000+ units. Fleet management via the Arc 2.0 cloud platform now supports multi-robot coordination.',
    specs: {
      height: 177,
      weight: 63,
      dof: 34,
  ...
  // ── 30. NVIDIA Project GR00T ──────────────────────────────────────────
  {
    ...
    description:
      'NVIDIA\'s Project GR00T is a foundation-model platform for humanoid robots rather than a single robot. It provides Isaac Sim digital twins, Omniverse coordination, and the GR00T N1 model for multimodal perception and action. Hardware partners (Unitree, Apptronik, 1X, Figure AI) build robots that run on the GR00T stack. Jensen Huang called it "the ChatGPT moment for robotics."',
    specs: {
      height: null,
      weight: null,
      dof: null,
  ...
  // ── 31. Galbot G1 ─────────────────────────────────────────────────────
  {
    ...
    description:
      'A Shenzhen-based newcomer offering a compact, affordable humanoid with an open-source software stack. The Galbot G1 features a 3D-printed modular chassis, ROS 2 integration out of the box, and a community marketplace for sharing trained behaviors. Particularly popular with university robotics labs and indie developers for its low cost and hackability.',
    specs: {
      height: 155,
      weight: 38,
      dof: 36,
  ...
  // ── 32. Mentee Bot ─────────────────────────────────────────────────────
  {
    ...
    description:
      'Founded by Prof. Amnon Shashua (co-founder of Mobileye), Mentee Robotics is developing a transformer-based humanoid that learns entirely from simulation. The Mentee Bot uses no traditional robotics programming — all motor control is derived from large-scale neural networks trained in NVIDIA Isaac Sim. Targeting a 2027 launch with a focus on home assistance and elderly care.',
    specs: {
      height: 168,
      weight: 55,
      dof: 42,
