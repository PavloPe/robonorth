...
export default function PartsError({
  ...
  useEffect(() => {
    console.error('[RoboNorth Parts Error]', {
  ...
  return (
    <div className="min-h-[60vh] flex items-center justify-center px-4">
      <div className="text-center max-w-md">
        ...
        <h1 className="text-2xl font-bold text-gray-900 dark:text-white mb-3">Error loading parts</h1>
        <p className="text-gray-500 dark:text-gray-400 mb-4 text-sm leading-relaxed">
          Something went wrong while loading the parts catalog.
